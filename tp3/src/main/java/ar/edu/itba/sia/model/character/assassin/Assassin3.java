...
public class Assassin3 extends Assassin {
    ...
    private static final double HEALTH_FACTOR = 1.0;

    public Assassin3 (final double height, final List<Equipment> equipment) {
        super(height, equipment);
    }

    public Assassin3(final double height, final Armor armor, final Boots boots, final Gloves gloves,
    ...
    public Character newSon(double height, List<Equipment> equipment) {
        return new Assassin3(height, equipment);
    }
