...
public class HelmetParser extends EquipmentParser {

    public static List<Helmet> parse(final String fileName) throws IOException {

        List<Helmet> helmets = new LinkedList<>();
